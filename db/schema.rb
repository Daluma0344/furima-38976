...
ActiveRecord::Schema.define(version: 2023_04_05_053415) do
  ...
  create_table "shopping_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
